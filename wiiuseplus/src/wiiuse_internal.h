...
#define WM_EXP_MOTION_PLUS			0x04A60000
...
// Holder value, need to find real one
#define EXP_ID_CODE_MOTION_PLUS					0x9A1EFDFA
...
#define WIIMOTE_STATE_MOTION_PLUS			0x4000
